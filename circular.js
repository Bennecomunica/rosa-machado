...
function circularBody(a){var parc=Number(state.config&&state.config.parcelas)||12;var mensalNum=(typeof valorLiquido==='function')?valorLiquido(a):Number(a.mensalidade||0);var tem=Number(a.mensalidade)>0&&mensalNum>0;var mensal=tem?money(mensalNum).replace('R$ ',''):'_________';var anual=tem?money(mensalNum*parc).replace('R$ ',''):'_________';var nome=esc(a.nome||'');var nomeForm=nome;var ano=esc(a.serieDestino||'');var periodo=esc(a.periodo||'');return `<div class="page">
